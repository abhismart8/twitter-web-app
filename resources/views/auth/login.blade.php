...
<div class="row login">
    <div class="col-sm-7">
        <img src="{{ asset("images/login-image.png") }}" class="img-fluid" style="border-radius: 5px;">
    </div>
    <div class="col-sm-4">
        ...
        <div class="" style="margin-bottom: 50px;">
            <h1 class=""><strong> Happening now </strong></h1>
        </div>

        <div class="mb-15">
            <h2> <strong> Join Twitter today. </strong></h2>
        </div>
